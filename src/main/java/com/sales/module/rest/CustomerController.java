...
public class CustomerController  extends AbstractRestController{
    ...
    @ResponseBody
    public SalesPlayMapping addPaintPoints1(@PathVariable final String salesPlayName,@PathVariable final Long mappingId,@RequestParam("paintPoint")  MultipartFile paintPoint,
    ...
    @ResponseBody
    public SalesPlay searchByIdWithMapping(@PathVariable final Integer playId)  {
    ...
    @ResponseBody
    public SalesPlayMapping createProductData(@PathVariable final String salesPlayName,@PathVariable final Long mappingId,@RequestParam("productAwards")  MultipartFile productAwards,
